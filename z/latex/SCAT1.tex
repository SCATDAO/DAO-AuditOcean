...
$\emph{indexParam} \leq \emph{totalNumProjects}$  $\Rightarrow$ \text{True}. Where \emph{indexParam} is the parameter sent by the user and \emph{totalNumProjects} is the total number of project indexes listed by the community.
